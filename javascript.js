...
// this is the code to the mouse trail on the webpage
...
// this is the code to the scripts on the webpage

// timed message
/*
if (new Date().getHours() >= 20 && new Date().getHours() < 24) {
    document.getElementById("t").innerHTML = "Greetings!"; 
}
...
else if (new Date().getHours() >= 15 && new Date().getHours() < 20) {
...
var x = Math.floor(size*Math.random() * 19);

image[0] = "https://pcbcat.neocities.org/buy-com-2000.gif";
image[1] = "https://pcbcat.neocities.org/yahoo-1996.jpg";
image[2] = "https://pcbcat.neocities.org/header06.gif";
image[3] = "https://pcbcat.neocities.org/header07.gif";
image[4] = "https://pcbcat.neocities.org/hotmail-2000.gif";
image[5] = "https://pcbcat.neocities.org/hp-shopping-2000.gif";
image[6] = "https://pcbcat.neocities.org/ibm-1997.gif";
image[7] = "https://pcbcat.neocities.org/intel-internet-video-phone-1996.gif";
image[8] = "https://pcbcat.neocities.org/internet-explorer-3-0-1996.gif";
image[9] = "https://pcbcat.neocities.org/mac-mall-1998.gif";
image[10] = "https://pcbcat.neocities.org/macromedia-flash-3-1998.gif";
image[11] = "https://pcbcat.neocities.org/pentium-1999.gif";
image[12] = "https://pcbcat.neocities.org/pizza-hut-1998.gif";
image[13] = "https://pcbcat.neocities.org/windows-95-1996.gif";
image[14] = "https://pcbcat.neocities.org/yahoo-pager-1998.gif";
image[15] = "https://pcbcat.neocities.org/apple-1997.jpg";
image[16] = "https://pcbcat.neocities.org/ibm-1996.jpg";
image[17] = "https://pcbcat.neocities.org/adobe20001217.gif";
image[18] = "https://pcbcat.neocities.org/win98.gif";

$('#adimg').attr('src',image[x]);
...
function detectOS() {
  ...
  let userOS = detectOS();
	if (macosPlatformsNew.indexOf(platform) !== -1) {
		...
		os = 'Mac OS Old' && document.getElementById("os").innerHTML("How are you even on the internet:" + userOS);
